...
@section('page-title', 'New Startup')

@section('content')
<div class="max-w-2xl mx-auto" x-data="{ founders: [''] }">
    <form method="POST" action="{{ route('portal.admin.startups.store') }}" class="space-y-6">
        @csrf
